...
AGENTS: tuple[Agent, ...] = (
    Agent(
        agent_id="Orkio",
        display_name="Orkio",
        description="Primary platform orchestrator.",
        capabilities=("chat", "routing", "coordination"),
    ),
    Agent(
        agent_id="Orion",
        display_name="Orion",
        description="Technical architecture and engineering specialist.",
        capabilities=("architecture", "engineering", "audit"),
    ),
    Agent(
        agent_id="Chris",
        display_name="Chris",
        description="Business and strategy specialist.",
        capabilities=("strategy", "business", "analysis"),
    ),
    Agent(
        agent_id="Laura",
        display_name="Laura",
        description="Communication and customer experience specialist.",
        capabilities=("communication", "customer_experience"),
    ),
)
