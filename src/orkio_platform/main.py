...
from orkio_platform.observability.http import request_observability_middleware
...
def create_app() -> FastAPI:
    ...
    for router in [health.router, agents.router, threads.router, chat.router, admin.router, governance.router]:
